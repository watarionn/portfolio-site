...
assert len(layout['projectPlacements'])==16
...
print('Portfolio City R6 scale recalibration contract passed: 13 chunks / 16 authored project widths / world-project layer')

...
<main class="geo-page">
  ...
  <section class="geo-results" id="results" aria-label="検索結果"></section>

  <section class="geo-section">
    <h2 class="geo-section-title">データから見る</h2>
    <div class="geo-specials">
      <a href="../same-name/?station=住吉"><strong>同名駅</strong><span>同じ駅名がどこにあるかを見る</span></a>
      <button type="button" data-special="reading"><strong>同じ字・違う読み</strong><span>七日町などを検索して比べる</span></button>
      <a href="../line/?line=五能線"><strong>沿線</strong><span>五能線を駅順に辿る</span></a>
    </div>
  </section>

  <section class="forest-wrap">
    <a class="geo-forest-link" href="../explore/">森に入る →</a>
  </section>
</main>

...
assert len(layout['projectPlacements'])==14
...
print('Portfolio City R6 scale recalibration contract passed: 13 chunks / 14 authored project widths / world-project layer')
